...
export function SectionHeading({ eyebrow, title, copy, dark = false }: { eyebrow: string; title: string; copy: string; dark?: boolean }) {
  return (
    <div className="max-w-3xl copper-line pl-5">
      <p className={`font-display text-sm font-bold uppercase tracking-[0.24em] ${dark ? "text-[#f5a623]" : "text-[#b86f3c]"}`}>{eyebrow}</p>
  ...
  return (
    <section id="contact" className="scroll-mt-32 bg-[#102941] py-24 text-white">
      <div className="container grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <form action={BUSINESS.emailHref} method="post" encType="text/plain" className="trade-card bg-[#faf8f5] p-6 text-[#173557]">
