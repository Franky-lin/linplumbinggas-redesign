...
const services = [
  ...
  { icon: Droplets, title: "通渠｜排水管维修", text: "针对下水慢、排水堵塞、地漏返水、马桶堵塞、排水管维修和雨水管问题，可结合 CCTV 管道检测判断。", image: REAL_PHOTOS.cctvDrainInspection, href: "/zh/blocked-drains" },
  { icon: Gauge, title: "热水器维修与安装", text: "处理没有热水、热水器漏水、热水炉安装、热水系统更换建议、住宅热水器安装与管路连接。", image: REAL_PHOTOS.residentialHotWaterInstall, href: "/zh/hot-water" },
  { icon: Flame, title: "持牌煤气工｜燃气安装", text: "提供燃气安装、煤气维修、LPG/GAS 连接、燃气表相关检查与合规导向施工。", image: REAL_PHOTOS.gasMeterTest, href: "/zh/gas" },
  { icon: Droplets, title: "雨水排水与屋顶雨水系统", text: "处理 stormwater system、屋顶雨水系统改造、雨水管、地面排水、户外排水管路和疑似雨水倒灌问题。", image: REAL_PHOTOS.stormwaterDrainage, href: "/zh/blocked-drains" },
...
const faqs = [
  ...
  { question: "可以做通渠、排水管维修和雨水管维修吗？", answer: "可以。服务范围包括通渠、下水道疏通、排水堵塞、排水管维修、stormwater system、雨水管问题、屋顶雨水系统改造和 CCTV 管道检测辅助判断。" },
...
export default function ZhHome() {
  const schema = [
    localBusinessSchema({
      ...
      serviceType: ["悉尼水管工", "悉尼华人水管工", "悉尼中文水管工", "Eastwood 水管工", "悉尼煤气工", "通渠", "排水管维修", "屋顶雨水系统改造", "下水道疏通", "热水器维修", "漏水维修", "24小时紧急水管服务"],
    }),
    ...
    <PageShell>
      ...
      <section className="relative isolate min-h-[760px] overflow-hidden bg-[#102941] text-white">
        ...
        <div className="container grid min-h-[760px] items-center gap-10 py-20 lg:grid-cols-[1.08fr_0.72fr]">
          <div className="max-w-4xl animate-slow-rise">
            ...
            <h1 className="font-display text-5xl font-bold leading-[1.02] tracking-tight md:text-7xl lg:text-8xl">悉尼水管工｜华人水管工与持牌煤气工</h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/82">Lin Plumbing & Gas 为悉尼华人和本地客户提供水管、通渠、排水管维修、屋顶雨水系统改造、热水器维修、煤气安装、漏水维修、雨水排水系统和泵系统服务。中文/英文可沟通，覆盖 Eastwood、Chatswood、Hurstville、Burwood、Epping、Ryde 及悉尼全区。</p>
          ...
          <aside className="trade-card hidden bg-[#faf8f5]/95 p-6 text-[#173557] shadow-2xl lg:block">
            ...
            <div className="mt-6 space-y-4">
              {["持牌服务", "中文沟通", "悉尼全区", "24小时紧急"].map((item, index) => {
                ...
                return <div key={item} className="flex gap-4 border-l-4 border-[#f5a623] bg-white p-4"><Icon className="mt-1 h-6 w-6 shrink-0 text-[#8a4e20]" /><div><p className="font-display text-xl font-bold">{item}</p><p className="text-sm font-semibold text-[#627386]">{index === 0 ? BUSINESS.license : index === 1 ? "普通话/中文沟通服务内容" : index === 2 ? "Sydney-wide service" : "紧急水管、排水、燃气"}</p></div></div>;
              })}
            </div>
          </aside>
        </div>
      ...
      <section className="bg-[#faf8f5] py-14">
        <div className="container grid gap-8 border-l-8 border-[#f5a623] bg-white p-6 shadow-sm lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:p-8">
          <div>
            <p className="font-display text-sm font-bold uppercase tracking-[0.24em] text-[#8a4e20]">中文客户服务</p>
            <h2 className="mt-3 font-display text-4xl font-bold leading-none text-[#173557] md:text-6xl">中文沟通，清楚确认服务内容与现场情况</h2>
          </div>
          <div>
            <p className="text-lg leading-8 text-[#526476]">如果你正在找“悉尼水管工”“悉尼华人水管工”“Eastwood 水管工”或“排水管维修”，Lin Plumbing & Gas 可以协助漏水、堵塞、没有热水、燃气安装和屋顶雨水系统等问题。你可以先查看对应服务范围，再电话说明地址和现场情况。</p>
            <div className="mt-5 flex flex-wrap gap-2">
              {["悉尼水管工", "悉尼华人水管工", "Eastwood 水管工", "排水管维修", "屋顶雨水系统改造", "中文服务", "24小时紧急水管"].map((tag) => <span key={tag} className="border border-[#173557]/15 bg-[#faf8f5] px-3 py-2 text-sm font-bold text-[#173557]">{tag}</span>)}
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="engineering-paper scroll-mt-32 py-24">
        <div className="container">
          <SectionHeading eyebrow="服务项目" title="悉尼水管工、通渠、排水管维修、热水器与煤气服务" copy="下面按客户常见叫法和实际现场问题整理服务范围。你可以先选择需要的项目，再通过电话或询价信息说明现场情况、所在区域和是否紧急。" />
            ...
            {services.map((service, index) => {
              ...
              return (
                <article key={service.title} className="trade-card overflow-hidden bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between gap-5"><div className="flex h-14 w-14 shrink-0 items-center justify-center bg-[#f5a623] text-[#142f4d]"><Icon className="h-7 w-7" /></div><span className="font-display text-sm font-bold text-[#8a4e20]">0{index + 1}</span></div>
                    ...
                    <a href={service.href} className="mt-5 inline-flex font-bold text-[#8a4e20] hover:text-[#173557]">查看服务详情 →</a>
                  </div>
                </article>
              );
            })}
      ...
      <section className="bg-[#102941] py-24 text-white">
        <div className="container grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div>
            <SectionHeading dark eyebrow="详细服务" title="按问题类型查看更详细的中文服务内容" copy="通渠、热水器、煤气和漏水维修等常见问题都有更清楚的中文介绍，方便你判断是否需要尽快联系、现场可能需要检查哪些位置，以及可以提前准备哪些信息。" />
      ...
      <section id="areas" className="engineering-paper scroll-mt-32 py-24">
        <div className="container grid gap-10 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
          ...
          <div>
            <SectionHeading eyebrow="服务区域" title="悉尼常见华人社区与服务区域" copy="Lin Plumbing & Gas 服务悉尼多个区域，包括 Eastwood、Chatswood、Hurstville、Burwood、Epping、Ryde 及周边 suburb。你可以查看所在区域的服务内容，或直接电话确认是否可安排。" />
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
      ...
      <section className="bg-white py-20">
        <div className="container grid gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
          <div>
            <p className="font-display text-sm font-bold uppercase tracking-[0.24em] text-[#8a4e20]">客户常用叫法</p>
            <h2 className="mt-3 font-display text-5xl font-bold leading-none text-[#173557] md:text-7xl">按你习惯的说法找服务</h2>
            <p className="mt-6 text-lg leading-8 text-[#526476]">不同客户会用不同叫法描述同一个现场问题。下面这些说法都可以直接告诉我们，方便更快判断属于漏水、通渠、热水、燃气还是雨水排水系统问题。</p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ["悉尼水管工 / 华人水管工", "住宅、商铺、餐馆、物业维护及紧急水管问题。"],
              ["Eastwood 水管工", "Eastwood、Epping、Ryde、Carlingford 等周边可联系确认安排。"],
              ["排水管维修 / 通渠", "地漏返水、马桶堵塞、下水慢、异味和 CCTV 管道检测。"],
              ["屋顶雨水系统改造", "stormwater、雨水管、户外排水、地面排水和雨天倒灌问题。"],
            ].map(([term, copy]) => <article key={term} className="trade-card border-l-4 border-[#f5a623] bg-[#faf8f5] p-6 shadow-sm"><h3 className="font-display text-2xl font-bold leading-tight text-[#173557]">{term}</h3><p className="mt-3 text-base leading-7 text-[#526476]">{copy}</p></article>)}
          </div>
        </div>
      </section>
